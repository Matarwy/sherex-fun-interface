            ...
            <Flex direction="column" gap={4}>
              ...
              <Box>
                <Flex alignItems="center" gap={1} mb={3}>
                  ...
                  <Tooltip backgroundColor={colors.backgroundLight} hasArrow placement="top" label={'A square image of at least 128x128 is suggested. File size cannot exceed 5mb.'}>
              ...
              <Button size="lg" type="submit" isDisabled={isSignIn && !configInfo}>
                {isSignIn ? 'Launch New' : 'Sign In to Launch New'}
              </Button>
            </Flex>
          </form>
        )}
              ...
              >
                ...
                >
                  <Box color={colors.lightPurple} fontWeight="medium">
                    ...
                    {!errors.tokenSoldPercent ? (
                      <Text color="#aaef6e" fontSize={['xs', 'sm']} mt="1">
                        {formatCurrency(
