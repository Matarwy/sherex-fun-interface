        ...
        >
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart data={data}>
              ...
              {firstPoint && <ReferenceDot x={firstPoint.x} y={firstPoint.price} yAxisId="left" r={6} fill="#ECF5FF" stroke="#aaef6e" />}
              {lastPoint && <ReferenceDot x={lastPoint.x} y={lastPoint.price} yAxisId="left" r={6} fill="#22D1F8" stroke="#aaef6e" />}
            </AreaChart>
          </ResponsiveContainer>
        </Box>
      ) : (
