...
import { SherexMintInfo } from '../type'
import { useStateWithUrl } from '@/hooks/useStateWithUrl'
import useSherexSearchMint from '@/hooks/launchpad/useSherexSearchMint'
...
export const SearchInput = forwardRef(({ includeNsfw, onSearchResultChange }: Props, ref: Ref<HTMLInputElement>) => {
  ...
  const { data, hasNextPage, onLoadMore, isLoading } = useSherexSearchMint({
    search: searchTerm,
    includeNsfw
  })
