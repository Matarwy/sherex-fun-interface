            ...
            <Box overflow={'hidden'} display={'flex'} flexDirection={'column'}>
              ...
              <Flex align="start" flexDirection="column" color={colors.textSecondary} px={3} mt={12}>
                ...
                <Flex flexDirection="column" align="flex-start" justify="flex-start" pl={1} textAlign="start" mt={5} fontSize="14px">
                  <HStack>
                    <DesktopIcon />
                    <Text fontWeight="medium">On desktop:</Text>
                  </HStack>
                  <UnorderedList mt={1} pl={10}>
                    <ListItem>Install at link above then refresh this page</ListItem>
                  </UnorderedList>
                </Flex>
              </Flex>
              ...
              {!isMobile && (
                ...
                >
                  <HStack>
                    ...
                    <Text>Show uninstalled wallets</Text>
                  </HStack>
                  <Switch checked={canShowUninstalledWallets} onChange={() => setCanShowUninstalledWallets((b) => !b)} />
                </Flex>
              )}
              ...
              >
                ...
                >
                  ...
                  <Link as={NextLink} href="https://docs.raydium.io/raydium/" _hover={{ textDecoration: 'none' }} isExternal>
                    <HStack gap={1}>
                      <Text>Get started on Raydium</Text>
...
function WalletItem({
  ...
  return (
    <Flex
      ...
      rounded="md"
      _hover={
        selectable ? { bg: isLight ? '#aaef6e' : '#524c92', color: isLight ? colors.textRevertPrimary : colors.textPrimary } : undefined
      }
      ...
      {/* {wallet.adapter.name === 'Phantom' && (
        <HStack gap={1} backgroundColor={colors.selectInactive} px={2} py={1} borderRadius="8px">
          ...
          <QuestionToolTip
            label={
              <Text>
                Auto-confirm is now available for all transactions on Raydium. <Link href="https://phantom.com/learn/blog/auto-confirm" isExternal>Learn More</Link>
              </Text>
            }
