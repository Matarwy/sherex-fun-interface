  ...
  return isActive ? (
    ...
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" className="chakra-icon" {...restProps} xmlns="http://www.w3.org/2000/svg">
      <path
        ...
        stroke="#fff3bf"
      />
      <path d="M4.01898 14.5235L2.66395 16.1557" stroke="#fff3bf" strokeLinecap="round" />
      <path
        d="M13.9926 11.4336C14.2398 12.1919 14.6599 13.936 14.3633 14.8459C14.0667 15.7559 11.7681 16.9944 10.6559 17.4999L10.2852 14.0876"
        stroke="#fff3bf"
      />
      <path
        ...
        stroke="#fff3bf"
      />
      <ellipse cx="13.9934" cy="6.12548" rx="0.741486" ry="0.758294" fill="#fff3bf" />
      <path d="M5.99073 16.9991L4.19235 19.1821" stroke="#fff3bf" strokeLinecap="round" />
    </svg>
  )
}
