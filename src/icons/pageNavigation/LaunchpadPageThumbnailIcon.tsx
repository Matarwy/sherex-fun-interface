  ...
  return isActive ? (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" className="chakra-icon" {...restProps} xmlns="http://www.w3.org/2000/svg">
      ...
      <path
        ...
        strokeWidth="1.4"
      />
      <path d="M4.01898 14.5235L2.66395 16.1557" stroke="#f8d222" strokeWidth="1.4" strokeLinecap="round" />
      <path
      ...
      <ellipse cx="13.9934" cy="6.12548" rx="0.741486" ry="0.758294" fill="#f8d222" />
      <path
      ...
      />
      <path d="M5.99073 16.9991L4.19235 19.1821" stroke="#f8d222" strokeWidth="1.4" strokeLinecap="round" />
    </svg>
  ) : (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" className="chakra-icon" {...restProps} xmlns="http://www.w3.org/2000/svg">
      <path
