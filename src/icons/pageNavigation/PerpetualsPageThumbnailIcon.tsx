...
export default function PerpetualsPageThumbnailIcon(props: SvgIcon & { isActive?: boolean; colorMode?: ColorMode }) {
  ...
  return isActive ? (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" {...restProps} className="chakra-icon" xmlns="http://www.w3.org/2000/svg">
      <circle opacity="0.8" cx="11" cy="11" r="4" fill="#aaef6e" />
    ...
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" {...restProps} className="chakra-icon" xmlns="http://www.w3.org/2000/svg">
      <rect x="4" y="5.5" width="4" height="9" rx="0.5" stroke="#fff3bf" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M6 5.5V1.5" stroke="#fff3bf" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M6 18.5V14.5" stroke="#fff3bf" strokeLinecap="round" strokeLinejoin="round" />
      <rect x="12" y="7" width="4" height="6" rx="0.5" stroke="#fff3bf" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M14 6.5V3" stroke="#fff3bf" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M14 17.5V13.5" stroke="#fff3bf" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  )
}
