...
export default function CreditCardIcon(props: SvgIcon) {
  ...
  return (
    ...
    >
      ...
      />
      <rect x="3" y="10.25" width="2.5" height="1.5" fill="#aaef6e" />
      <rect x="6.5" y="10.25" width="2.5" height="1.5" fill="#aaef6e" />
      <rect x="10" y="10.25" width="2.5" height="1.5" fill="#aaef6e" />
    </svg>
  )
}
