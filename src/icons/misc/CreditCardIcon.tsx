...
export default function CreditCardIcon(props: SvgIcon) {
  ...
  return (
    ...
    >
      <path d="M0.75 7.5H17.25" stroke="#FFCC00" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      <path
      ...
      />
      <rect x="3" y="10.25" width="2.5" height="1.5" fill="#EB5B00" />
      <rect x="6.5" y="10.25" width="2.5" height="1.5" fill="#EB5B00" />
      <rect x="10" y="10.25" width="2.5" height="1.5" fill="#EB5B00" />
    </svg>
  )
}
